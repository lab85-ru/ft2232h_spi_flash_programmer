...
extern const struct mem_chip_st chip_st_m25p80;
// function ===================================================================
...
const struct mem_chip_st chip_st_m25p80 = {
    "ST_M25P80",     // name
	1*1024*1024,  // density(bytes)
...
#define MANUFACTURE_ID  (0x13)

//#define MANUFACTURE_ID  (0x13)
//#define MEM_TYPE_ID     (0x20)
//#define MEM_CAPACITY_ID (0x15)
...
static FT_STATUS write(FT_HANDLE ftHandle, const uint32 adr_start, uint8 *buf, const uint32 size_for_write, uint32 * sizeTransfered)
{
	...
	if ((adr_start & (chip_st_m25p80.prog_buf_size - 1)) != 0){
...
static FT_STATUS erase( FT_HANDLE ftHandle, const uint32 adr_sec)
{
	...
	if (adr_sec % chip_st_m25p80.sector_erase_size){ // adr ne virovene na granicu sectora !!!
